...
Write-Host $ansibleRunnerPassword -ForegroundColor Green 
...
$ansibleCert = Get-ChildItem -Path 'Cert:\LocalMachine\Root' | Where-Object {$_.Subject -eq 'CN=ansible'}
